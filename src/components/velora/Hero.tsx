...
export function Hero() {
  return (
    <section id="top" className="relative pt-24 md:pt-28 pb-16 md:pb-20 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="reveal delay-1 font-display text-[40px] sm:text-5xl lg:text-[76px] leading-[0.96] tracking-[-0.03em] text-charcoal max-w-5xl mx-auto">
            ...
            <br />
            <em className="font-script not-italic text-burgundy text-[1.12em] inline-block mx-2">
              impossible
            </em>
          ...
          <p className="reveal delay-2 mt-6 max-w-[560px] mx-auto text-base md:text-[17px] text-muted-foreground leading-7">
            Velora designs and develops thoughtful websites for businesses,
            founders, and creators who want to stand out online. Every project
            is crafted from the ground up with clarity, creativity, and purpose.
          </p>

          <div className="reveal delay-3 mt-8 flex justify-center">
            <a
              href="/inquiry"
              className="group inline-flex items-center gap-3 bg-burgundy text-cream px-8 py-4 text-[11px] tracking-[0.22em] uppercase hover:bg-wine transition-colors"
            >
              Book A Call With Us
